...
export PATH=/opt/anaconda/bin:$PATH && quast --fast -o ${srr_id}_quast_output ${srr_id}_contigs.fasta || true  # true is because Quast give exit code=-1 for contigs with low quality
