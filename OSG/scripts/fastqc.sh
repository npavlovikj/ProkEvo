...
mkdir -p ${srr_id}_pair_1_trimmed_fastqc
mkdir -p ${srr_id}_pair_2_trimmed_fastqc
touch ${srr_id}_pair_1_trimmed_fastqc/summary.txt
touch ${srr_id}_pair_2_trimmed_fastqc/summary.txt
