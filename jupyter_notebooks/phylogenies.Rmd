...
tree_group_1 <- read.tree("~/Documents/natasha_papers/prokevo/jejuni_phylogeny_gr1.tree")

#############################################

# Enter Baps 1-6 for group1

baps_group_1 <- read_csv('~/Documents/natasha_papers/prokevo/output.roary_output_95_95_1.fastbaps_level_6.csv')
...
mlst <- read_csv('~/Documents/natasha_papers/prokevo/mlst_output.csv')
...
tree_group_1 <- read.tree("~/Documents/natasha_papers/prokevo/saureus_phylogeny_gr1.tree")

#############################################

# Enter Baps 1-6 for group1

baps_group_1 <- read_csv('~/Documents/natasha_papers/prokevo/output.roary_output_1.fastbaps_level_6.csv')
...
mlst <- read_csv('~/Documents/natasha_papers/prokevo/saureusmlst.csv')
